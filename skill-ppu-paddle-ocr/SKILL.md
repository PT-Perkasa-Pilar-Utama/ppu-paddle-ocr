...
For CDN / no-bundler setups, point at the published ESM build directly (see the live demo at https://pt-perkasa-pilar-utama.github.io/ppu-paddle-ocr/ for a complete reference).
